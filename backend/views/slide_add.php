            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('slide/insert'); ?>">
                           ...
                           <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="file" name="slide_image" id="slide_image"><br/><p style="font-size:16px;font-weight:600">
                                    <span style="font-size:16px;font-weight:600"><?php foreach($category_slide_list as $vv):?><?php echo $vv['category_slide_name']?> : <?php echo $vv['category_slide_width']?> px * <?php echo $vv['category_slide_height']?> px<?php endforeach;?></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="radio" name="slide_option" value="0" checked>YES</label>
                                    <label class="checkbox-inline i-checks">
                                    <input type="radio" name="slide_option" value="1">NO</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="slide_description" id="slide_description">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
