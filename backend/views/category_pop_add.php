            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        <h5>Create New Category Pop</h5>
                    </div>
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('category_pop/insert'); ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Category Pop Name</label>

                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="category_pop_name" id="category_pop_name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="category_pop_url" id="category_pop_url">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
