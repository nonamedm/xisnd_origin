    ...
    <div class="row">
	  ...
	  <div class="product_list text-center">
		...
		<ul class="nav-tabs">
			...
			<li class="active"><a href="<?php echo site_url('page/products')?>?active=cat_02">홈오토메이션 시스템</a></li>
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						...
	  						<li>크기 : 302(W) X 131(H) X 31.5(D)mm</li>
	  					</ul>
	  				</div>
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						<li>통화 및 문 열림 : 세대현관/공동현관 방문자 영상 확인 및 통화,공동현관 문열림, 디지털도어락 문열림 연동,세대/경비실/관리사무소 영상통화, <br>
일반전화 수/발신</li>
	  						<li>홈 시큐리티 : 화재, 가스 방범, 비상 호출</li>
	  					<!-- 	<li>전원 : AC free voltage</li> -->
	  						<li>홈 컨트롤 : Sub-phone 연동(주방TV폰, 욕실TV폰, 욕실폰)</li>
	  					</ul>
	  				</div>
	  				<div class="clearfix"></div>
	  			</div> 
		...
		<div class="article">        
		   <p><a href="<?php echo site_url('page/product_1_2')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EHW-1060</a></p>
		   ...
		   <div class="list_button_block"><a href="<?php echo site_url('page/products')?>?active=cat_02" class="list_button">목록</a></div>
		</div>
	  	<div class="clearfix"></div>
	  </div>
    </div>
