            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5> 공사현장 </h5>
                        <a href="<?php echo site_url('sell/year_detail/'.$id['xi_article_index']); ?>" style='float:right;margin-right:10px;'><button type="button" class="btn btn-primary" style="padding: 6px 12px;">추가</button></a>
                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php foreach($year_list as $y): ?>
                                <tr>
                                    <td><?php echo $y['xi_year_index']; ?></td>

                                    <td><?php echo $y['xi_year_title']; ?></td>

									<td class="center">
									    <a href="<?php echo site_url('sell/year_detail'.'/'.$y['xi_article_index'].'/'.$y['xi_year_index']); ?>"><button class="btn btn-success" type="button"><i class="fa fa-paste"></i> 수정</button></a>
                                        
									    <a href="<?php echo site_url('sell/remove_year'.'/'.$y['xi_article_index'].'/'.$y['xi_year_index']); ?>"><button class="btn btn-danger" type="button"><i class="fa fa-times"></i> 지우기</button></a>
									</td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
