                ...
                <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('article/'.$form_type); ?>/news/lists/94">
                                <input type="hidden" name="category" value="<?php echo @$article->category_index?>">
                                <input type="hidden" name="article_index" value="<?php echo @$article->article_index?>">
                                <table class="table table-bordered form_table">
                                    <tbody>
                                        <tr>
                                            <td class="left">제목</td>
                                            <td><input type="text" placeholder="" class="form-control my_form_input" name="article_name" id="article_name" value="<?php echo @$article->article_name?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="left">분류</td>
                                            <td>
                                                <select class="form-control m-b" name="news_cg_index" id="news_cg_index">
                                                    <?php foreach($news_category as  $item): ?>
                                                        <option data-category ="<?php echo $item['category_index'] ?>"  value="<?php echo $item['news_cg_index'];?>">
                                                            <?php echo $item['news_cg_name'] ?>
                                                        </option>
                                                    <?php  endforeach; ?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="checkbox-inline i-checks">
                                                <input type="radio" name="article_is_top" value="1" <?php if(@$article->article_is_top == "1"):?>checked<?php endif;?>>YES</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label class="checkbox-inline i-checks">
                                                <input type="radio" name="article_display" value="0" <?php if(@$article->article_display == "0"):?>checked<?php endif;?>>NO</label>
                                            </td>
                                        </tr>
...
<script>
    ...
    {
        $('[name="category"]').val(  $("#news_cg_index").find("option:selected").attr('data-category') );
