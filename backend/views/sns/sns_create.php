            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal " enctype="multipart/form-data" action="<?php echo site_url('sns/process/sns_create'); ?>">
                            <div class="junde_form_template">
                                ...
                                <div class="form-group template_row seller_select">
                                    ...
                                    <label class="col-sm-2 cell_left control-label">
                                        Cover<span>*</span><br>
                                        ( <?php echo $aspect_width; ?> * <?php echo $aspect_height; ?> 픽셀 )
                                    </label>
                                    <div class="col-sm-10 cell_right" id="crop-avatar">
                                        ...
                                        <div class="table_upload_img avatar-view" style="width:<?php echo $aspect_width/2; ?>px; height:<?php echo $aspect_height/2; ?>px;">
                                            <img src="<?php echo base_url().'/resource/admin/images/my_page_header_img.jpg'; ?>" width="<?php echo $aspect_width/2; ?>" height="<?php echo $aspect_height/2; ?>" data-width="<?php echo $aspect_width; ?>" data-height="<?php echo $aspect_height; ?>" data-element-id="crop_thumbnail">
                                        </div>
                                ...
                                <div class="form-group template_row" >
                                    ...
                                    <div class="col-sm-10 cell_right">
                                        <input type="text" class="form-control" name="article_second_name" id="article_second_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group template_row" >
                                    ...
                                    <div class="col-sm-10 cell_right">
                                        <textarea style="min-height: 200px" name="article_description" id="article_description" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
