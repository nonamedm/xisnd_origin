            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5 style="width:100%">
                            Form Category
                            <a href="<?php echo site_url('form/categoryDetail'); ?>" style='float:right'><button type="button" class="btn btn-primary btn-sm">New Category</button></a>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <?php foreach($form_cg_list as $item):?>
                                <tr>
									<td><?php echo $item['form_cg_index'];?></td>
									<td><?php echo $category_value[$item['category_index']];?></td>
                                    <td><?php echo $item['form_cg_name'];?></td>
									<td><?php echo $this->enumvalue->y_n[$item['form_cg_display']];?></td>
									<td class="center">
									    <a href="<?php echo site_url('form/categoryDetail/'.$item['form_cg_index']); ?>">
                                            <button class="btn btn-success" type="button"><i class="fa fa-paste"></i> 상세</button>
                                        </a>
									    <a href="<?php echo site_url('form/processCategory/remove/'.$item['form_cg_index']); ?>" >
