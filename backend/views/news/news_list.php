                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php foreach ( $news_category as $index => $item ): ?>
                                        <label class="checkbox-inline i-checks">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php foreach($article_list as $item): ?>
                                <tr>
                                    ...
                                    <td> <?php echo mb_strlen( $item['article_name'] ) > 40 ? mb_substr( $item['article_name'], 0, 20, 'UTF-8' ).'...' : $item['article_name']; ?> </td>

                                    <td><?php echo !empty( $news_category[$item['news_cg_index']] ) ? $news_category[$item['news_cg_index']] : 'None'; ?></td>
									...
									<td class="center">
									    <a href="<?php echo site_url('news/detail'.'/'.$item['article_index']); ?>"><button class="btn btn-success" type="button"><i class="fa fa-paste"></i> 수정</button></a>
									    <a href="<?php echo site_url('article/remove'.'/'.$item['article_index'].'/news/lists/94'); ?>"><button class="btn btn-danger" type="button"><i class="fa fa-times"></i> 지우기</button></a>
									</td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
