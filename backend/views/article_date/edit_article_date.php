                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered form_table">
                            <tbody>
                                <form id="article" method="post" role="form" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('article_date/update_article_date'); ?>">
                                    <input type="hidden" name="article_date_index" value="<?php echo $single_article_date['article_date_index']?>">
                                    <tr>
                                        <td class="left">분류</td>
                                        <td>
                                            <select class="form-control my_form_input" name="category_date_index" id="category_date_index">
                                                <?php foreach($cate_date as $v):?>
                                                <option value="<?php echo $v['category_date_index']; ?>" data-type="" <?php if($single_article_date['category_date_index'] == $v['category_date_index']):?>selected<?php endif;?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <script>
                                                document.querySelector('[name="article_date_title"]').value='<?php echo $single_article_date['article_date_title']?>';
                                            </script>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="left">정렬</td>
                                        <td>
                                            <input type="text" class="form-control  my_form_input" name="article_date_sort" id="article_date_sort" value="<?php echo $single_article_date['article_date_sort'];?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="left">내용</td>
                                        <td>
                                            <textarea class="form-control my_form_input" id="editor" rows="5" name="article_date_content"><?php echo $single_article_date['article_date_content']?></textarea>
                                            <script>
                        ...
                        <div style="text-align: right;">
                            ...
                            <button class="btn btn-primary" type="button" onclick="window.location.href='<?php echo site_url('article_date/article_date_list/'.$single_article_date['category_date_index']);?>'">목록</button>
