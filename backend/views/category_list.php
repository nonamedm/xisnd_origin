            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						...
						<button type="button" class="btn btn-primary btn-xs">새 카태고리 추가</button>
						<?php endif; ?>
						</a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
							...
							<?php if(!empty($category_list)): $num=0; foreach($category_list as $v): $num++?>
                                <tr>
									...
									<td class="center">
									<?php if($v['category_template_module'] != "page"): ?>
									<a href="<?php echo site_url('article/category'.'/'.$v['category_index']); ?>"><button class="btn btn-info" type="button"><i class="fa fa-search"></i> 게시글 보기</button></a>
									<?php endif; ?>

									<a href="<?php echo site_url('category/edit'.'/'.$v['category_index']); ?>"><button class="btn btn-success" type="button" ><i class="fa fa-paste"></i> 수정</button></a>

									<?php if($this->session->admin_grade < 0): ?>
									<a href="<?php echo site_url('category/remove'.'/'.$v['category_index']); ?>"><button class="btn btn-danger" type="button"><i class="fa fa-times"></i> 지우기</button></a>
									<?php endif; ?>
									</td>
                                </tr>
                            <?php 
