    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li data-active = "Categorys">
                    <a href="#">
                        <i class="fa "></i>
                        <span class="nav-label">메뉴 카테고리</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li data-active = "lists"  >
                            <a class="J_menuItem" href="<?php echo site_url('Categorys/lists')?>">리스트</a>
                        </li>
                    </ul>
                </li>
                <li data-active = "form">
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">관리자 정보</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">

                        <li>
                            <a class="J_menuItem" href="<?php echo site_url('admin'); ?>">관리자 목록</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo site_url('admin/add'); ?>">새 관리자 추가</a>
                        </li>
                    </ul>
                </li>
