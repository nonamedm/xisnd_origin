    ...
    var v = function (d, l) {
        ...
        return {
			...
			onResize : function(){
				...
				console.log( 'resize' , arguments , this )
                        ...
                        id: "basic", type: "vbox", children: [{
                            ...
                            type: "vbox", padding: 1, children: [{
                            ...
                            },
                                {
                                    ...
                                    "default": "center",
                                    items: [ [d.lang.common.notSet, ""] ,  [d.lang.common.alignCenter,'center'] , [d.lang.common.alignLeft, "left"] , [d.lang.common.alignRight, "right"] ],
                                    onChange: function () {
                                        e(this.getDialog());
                                        k.call(this, "advanced:txtdlgGenStyle")
                                    },
                                    ...
                                    commit: function (a,b) {
                                        ...
                                        if (1 == a || 4 == a) {
                                            ...
                                            if (c ? b.setStyle("float", c) : b.removeStyle("float"), c == 'center' && ( b.setStyle("display", 'block'),b.setStyle("margin-left", 'auto') ,b.setStyle("margin-right", 'auto') ) , 1 == a)
											{
                                        ...
                                        } else 8 == a && b.removeStyle("float") && b.removeStyle("display") && b.removeStyle("margin-left") && b.removeStyle("margin-right");
                                    }
                                }]
                        }]
                    }, {
