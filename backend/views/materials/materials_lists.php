            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5  style="width:100%">
                            커뮤니티
                            <a href="<?php echo site_url($form_url_1.'/'.$detail_url)?>" style="float:right"><button type="button" class="btn btn-primary btn-sm">Add</button></a>    
                        </h5>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php foreach($article_list as $item): ?>
                                <tr>
                                    ...
                                    <td class="center"><?php echo $item['article_name']; ?> </td>
                                    <td class="center"><img style="height:50px;" src = "<?php echo base_url().$item['article_cover']?>"></td>
									...
									<td class="center">
									    <a href="<?php echo site_url($form_url_1.'/'.$detail_url.'/'.$item['article_index']); ?>"><button class="btn btn-success" type="button"><i class="fa fa-paste"></i> 수정</button></a>
									    <a href="<?php echo site_url('article/remove'.'/'.$item['article_index'].'/'.$form_url_1.'/'.$this->uri->segment(2).'/'.$item['category_index']); ?>"><button class="btn btn-danger" type="button"><i class="fa fa-times"></i> 지우기</button></a>
									</td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
