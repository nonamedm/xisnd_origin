            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('category/insert'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="checkbox-inline i-checks">
                                        <input type="radio" name="category_display" value="1" checked>YES</label>
                                    <label class="checkbox-inline i-checks">
                           ...
                           <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10"><textarea name="category_description" id="category_description" class="form-control"></textarea></div>
                            </div>
                            <div class="hr-line-dashed"></div>
