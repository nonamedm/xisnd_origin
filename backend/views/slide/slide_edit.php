...
.loading {
  ...
  <div class="container_crop" id="crop-avatar" style="">
    ...
    <div class="avatar-view" title="대표 이미지">
      <img src="<?php echo base_url() ?><?php echo $slide['slide_image']?>" style="width:260px;" alt="Avatar">
            ...
            <div class="modal-body">
              <div class="avatar-body">
                ...
                <div class="avatar-upload">
                  ...
                  <input type="hidden"  name="aspect_width" value="1500">
                  <input type="hidden"  name="aspect_height" value="700">
  ...
  <div class="hr-line-dashed"></div>
                    <div class="ibox-content" style="border:none;">
                        <form id="slide" method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('slide/update'); ?>">
                            <input type="hidden" name="slide_image" id="slide_image" value="<?php echo $slide['slide_image']?>" />
                            ...
                            <div class="col-sm-10">
                                    <select class="form-control m-b" onclick="select()" name="category_slide_index" id="category_slide_index">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="radio" name="slide_option" value="1" <?php if($slide['slide_option'] == 1):?>checked<?php endif;?>>공개</label>
                                    <label class="checkbox-inline i-checks">
                                    <input type="radio" name="slide_option" value="0" <?php if($slide['slide_option'] == 0):?>checked<?php endif;?>>비공개</label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="slide_first_row" id="slide_first_row" value="<?php echo $slide['slide_first_row']?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="slide_second_row" id="slide_second_row" value="<?php echo $slide['slide_second_row']?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="slide_third_row" id="slide_third_row" value="<?php echo $slide['slide_third_row']?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
