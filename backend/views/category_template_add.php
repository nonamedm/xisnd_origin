            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('category_template/insert'); ?>">

                            <div class="form-group">
                                <label class="col-sm-2 control-label">Category Template Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="category_template_name" id="category_template_name">
                                </div>
                            </div>
